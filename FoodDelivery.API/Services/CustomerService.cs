...
namespace FoodDelivery.API.Services
{
    public class CustomerService : ICustomerService
    {
        ...
        public CustomerService(ICustomerRepository repository, IMapper mapper, IPasswordHasher<Customer> passwordHasher)
        {
        ...
        public async Task<CustomerResponseDto> CreateCustomerAsync(CreateCustomerDto createCustomerDto)
        {
            ...
            customer.CustomerHashedPassword = _passwordHasher.HashPassword(customer, createCustomerDto.Password);
